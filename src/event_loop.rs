...
use crate::action::{Action, HELP_TEXT};
...
pub fn create_event_loop(state: &RefCell<WindowManager>) -> (CGEventTap<'_>, CFRunLoopSource) {
    let event_tap = {
        use CGEventType::*;
        CGEventTap::new(
            ...
            |_, _, _| CGEventTapCallbackResult::Keep,
        )
        .unwrap()
    };
